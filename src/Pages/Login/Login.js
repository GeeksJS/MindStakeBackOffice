        ...
        <React.Fragment>
            <div className="row min-vh-100 flex-center g-0">
                <div className="col-lg-8 col-xxl-5 py-3 position-relative">
                    <img
                        className="bg-auth-circle-shape" style={{ filter: 'brightness(0.5)contrast(2)hue-rotate(210deg)saturate(12)' }}
                        src="../../../assets/img/icons/spot-illustrations/bg-shape.png"
                        alt=""
                        width={250}
                    />
                    <img
                        className="bg-auth-circle-shape-2" style={{ filter: 'brightness(0.5)contrast(2)hue-rotate(210deg)saturate(12)' }}
                    ...
                    <div className="card overflow-hidden z-index-1">
                        <div className="card-body p-0">
                            <div className="row g-0 h-100">
                                <div className="col-md-5 text-center" style={{ backgroundImage: 'linear-gradient(-45deg, #007c1f, #00ac39)', backgroundPosition: 'center' }}>
                                    <div className="position-relative p-4 pt-md-5 pb-md-7 light">
                                        ...
                                        <div className="z-index-1 position-relative">
                                            ...
                                            <p className="opacity-75 text-white">
                                                With the power of MindStake, you can now focus only on
                                                functionaries for your digital business, while leaving the UI
                                                design on us!
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="p-4 p-md-5 flex-grow-1">
                                        ...
                                        <form onSubmit={doLogin}>
                                            ...
                                            <div className="row flex-between-center">
                                                <div className="col-auto">
                                                    <div className="form-check mb-0">
                                                        <input
                                                            ...
                                                            type="checkbox"
                                                            id="card-checkbox"
                                                            defaultChecked="checked" style={{ backgroundColor: '#007c1f' }}
                                                        />
                                                        <label
                                                ...
                                                <div className="col-auto">
                                                    <a
                                                        className="fs--1" style={{ color: '#007c1f' }}
                                            ...
                                            <div className="mb-3">
                                                <button
                                                    className="btn d-block w-100 mt-3" style={{ backgroundColor: '#007c1f', color: 'white' }}
                                                    type="submit"
                                                    name="submit"
                                                >
                                                    Log in
