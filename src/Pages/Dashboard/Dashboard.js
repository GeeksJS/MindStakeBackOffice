...
export default function Dashboard() {
    ...
    useEffect(() => {
        axiosconfig.get(`/projects/getallprojectsbycategory`)
            .then(res => {

                res.data && res.data.map((res) => {

                    category.push(res._id)
    ...
    useEffect(() => {
        axiosconfig.get(`/proposal/getallproposalbystate`)
            .then(res => {

                res.data && res.data.map((res) => {

                    status.push(res._id)
                    countProp.push(res.count)
                })
            })
                            ...
                            <div className="card overflow-hidden" style={{ minWidth: "12rem" }}>
                                ...
                                <div className="card-body position-relative">
                                    ...
                                    <div
                                        ...
                                        data-countup={`{"endValue":${complaints}}`}
                                    >
                                        {complaints}
                                    </div>
                                    <Link
                            ...
                            <div className="card overflow-hidden" style={{ minWidth: "12rem" }}>
                                ...
                                <div className="card-body position-relative">
                                    ...
                                    <div
                                        ...
                                        data-countup={`{"endValue":${projects}}`}
                                    >
                                        {projects}
                                    </div>
                                    <Link
